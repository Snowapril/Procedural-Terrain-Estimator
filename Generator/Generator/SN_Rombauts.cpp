 ...
 * http://webstaff.itn.liu.se/~stegu/SN_Rombauts/SN_Rombauts.java:
 ...
 */
float SN_Rombauts::noise(float x) {
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SN_Rombauts::noise(float x, float y) {
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SN_Rombauts::noise(float x, float y, float z) {
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SN_Rombauts::fractal(size_t octaves, float x) const {
    float output    = 0.f;
    float denom     = 0.f;
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SN_Rombauts::fractal(size_t octaves, float x, float y) const {
    float output = 0.f;
    float denom  = 0.f;
    float frequency = mFrequency;
    float amplitude = mAmplitude;
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SN_Rombauts::fractal(size_t octaves, float x, float y, float z) const {
    float output = 0.f;
    float denom  = 0.f;
    float frequency = mFrequency;
    float amplitude = mAmplitude;
