...
public:
	...
	void bindFramebuffer(int startX, int startY, int width, int height) const;
	void unbindFramebuffer(int startX, int startY, int width, int height) const;
	void unbindFramebuffer(const Util::Rect& rect) const;
