...
{
private:
	static vector < vector < unsigned char > > mapData;
	static vector < vector < pii > > descentTable;
	static int height, width;
	
public:

	Estimator(vector<unsigned char>& data,int _height, int _width) : height(_height), width(_width) {
	...
	// methods
	static void mapDataInit(vector<unsigned char>& data, const int height, const int width) {
