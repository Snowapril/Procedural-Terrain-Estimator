...
constexpr float REFLECTION_WIDTH	= 320.0f;
constexpr float REFLECTION_HEIGHT	= 160.0f;
constexpr float REFRACTION_WIDTH	= 1600.0f;
constexpr float REFRACTION_HEIGHT	= 900.0f;
